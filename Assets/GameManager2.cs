...
public class GameManager2 : MonoBehaviour
{
    ...
    public TankManager2[] m_Tanks;               // A collection of managers for enabling and disabling different aspects of the tanks.
    ...
    private TankManager2 m_RoundWinner;          // Reference to the winner of the current round.  Used to make an announcement of who won.
    private TankManager2 m_GameWinner;           // Reference to the winner of the game.  Used to make an announcement of who won.
    ...
    private TankManager2 GetRoundWinner()
    {
        float max = -1;
        int index = -1;
        // Go through all the tanks...
        for (int i = 0; i < m_Tanks.Length; i++)
        {
            ...
            TankCoin2 tank = m_Tanks[i].m_Instance.GetComponent<TankCoin2>();
            if (tank.m_CurrentCoin >= max)
            {
                if(tank.m_CurrentCoin == max)
                {
                    return null;
                }
                max = tank.m_CurrentCoin;
                index = i;
            }
    ...
    private TankManager2 GetGameWinner()
    {
        // Go through all the tanks...
        for (int i = 0; i < m_Tanks.Length; i++)
        {
